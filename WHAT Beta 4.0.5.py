...
#        self.setGeometry(350, 75, 800, 750)
        ...
        self.rainbird_pref = RainbirdPref(self)
...
##################################################################### @TAB ABOUT
    ...
    def initUI_About(self):
        ...
        about_text = '''<p align="center">
                        ...
                        <br>
                        <i>automated gap filling of daily weather records</i>
                        <br><br>
...
class RainbirdPref(QtCore.QThread):
    
    ConsoleSignal = QtCore.Signal(str)
    ErrorSignal = QtCore.Signal(str)
    
    def __init__(self, parent=None):
        super(RainbirdPref, self).__init__(parent)
