...
\begin{table}[!ht]
    ...
    \begin{tabular}{            
        ...
        *5S[table-format = 2.1]
    	...
    	\toprule
    	\multicolumn{6}{c}{}&\multicolumn{4}{c}{\% of days with missing data}\\
    	\cmidrule{7-10}
    	{\#} & {Station} & {Climate ID} & {Lat.} & {Lon.} & {Alt.} & {T\textsubscript{max}} & {T\textsubscript{min}} & {T\textsubscript{mean}} & {P\textsubscript{tot}} \\
    	\midrule
